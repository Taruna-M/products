...
const UpdateProduct = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`products-api-production-f11a.up.railway.app/getProds/${id}`);
    ...
    try {
      ...
      const response = await axios.put(`products-api-production-f11a.up.railway.app/updateProd/${id}`, updatedData, {
        headers: {
